...
public class Market {
    ...
    JugadorsEquip  CalcularEquipOptim(int PresupostFitxatges, int numOfThreads)
    {
        long maxbits;
        ...
        //Thread array
        threadEvaluater[] threads = new threadEvaluater[numOfThreads];
        ...
        for (int i=0; i<numOfThreads; ++i){
            ...
            threads[i] = new threadEvaluater(prevThreadEnd, threadEnd , PresupostFitxatges, this);
            threads[i].start();
            remaining -= pivot;
        }
